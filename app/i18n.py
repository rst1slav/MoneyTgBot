...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "ru": {
        ...
        "crypto.send.enter_amount": "<b>Введите сумму отправки:</b>",
        "crypto.send.insufficient": "🔻 У Вас недостаточно <b>{sym}</b> для совершения отправки (мин. {emoji} {min_amt} {sym}).",
        ...
        "crypto.send.enter_addr": "<b>Введите адрес для отправки:</b>",
        "crypto.send.addr_invalid": "❌ Неверный TON-адрес.",
        "crypto.send.confirm_title": "🔸 <b>Подтвердите отправку средств:</b>",
        "crypto.send.amount_line": "<b>Сумма отправки: {emoji} {amt} {sym}</b>",
        "crypto.send.addr_line": 'Адрес отправки: <a href="{url}">{short}</a>',
        ...
        "crypto.send.memo_title": "📤 Отправка",
        "crypto.send.memo_body": "Введите комментарий (MEMO) который хотите прикрепить к отправке.\n\nМаксимальная длина - <b>50 символов</b>.",
        ...
        "crypto.send.no_coins": "Нет валют, доступных для отправки.",
        "crypto.send.done_notify_html": '✅ <a href="{url}">Отправка</a> <b>{amt} {sym}</b>{base} успешно завершена.',
