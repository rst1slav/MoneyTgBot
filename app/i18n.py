...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "ru": {
        ...
        "crypto.send.min_line": "Минимальная сумма: <b>{amt} TON</b> в любой монете.",
        ...
        "crypto.send.pick_amount_body_line_fee": "Комиссия: {emoji} <b>{amt} {sym}</b>",
        "crypto.send.enter_amount": "<b>Введите сумму отправления:</b>",
        "crypto.send.insufficient": "🔻 У Вас недостаточно <b>{sym}</b> для совершения отправления (мин. {emoji} {min_amt} {sym}).",
        ...
        "crypto.send.amount_line": "<b>Сумма отправления: {emoji} {amt} {sym}</b>",
        ...
        "crypto.send.processing_body": "{emoji} <b>{amt} {sym}</b> будут отправлены на адрес <b>{short}</b> в течении пары минут.",
        "crypto.send.processing_body_html": '{emoji} <b>{amt} {sym}</b> будут отправлены на адрес <a href="{url}"><b>{short}</b></a> в течении пары минут.',
