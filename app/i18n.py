...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "ru": {
        ...
        "crypto.send.title": "📤 Отправить",
        "crypto.send.title_progress": "📤 Отправление в процессе",
        "crypto.send.pick_coin_title": "📤 Отправить",
        "crypto.send.pick_coin_body": "Выберите валюту, которую хотите отправить:",
        "crypto.send.min_line": "Минимальная сумма: {amt} TON в любой монете.",
        "crypto.send.pick_amount_body_line_network": "Сеть отправления: <b>TON</b>",
        "crypto.send.pick_amount_body_line_balance": "Баланс: 🪙 {amt} {sym}",
        "crypto.send.pick_amount_body_line_min": "Минимум: 🪙 <b>{amt} {sym}</b>",
        "crypto.send.pick_amount_body_line_fee": "Комиссия: 🪙 <b>{amt} {sym}</b>",
        "crypto.send.enter_amount": "<b>Введите сумму отправления:</b>",
        "crypto.send.insufficient": "🔻 У Вас недостаточно <b>{sym}</b> для совершения отправления (мин. 🪙 {min_amt} {sym}).",
        "crypto.send.btn_max": "Максимум • {amt} {sym}",
        "crypto.send.btn_pick_coin": "‹ Выбор валюты",
        "crypto.send.btn_pick_amount": "‹ Выбор суммы",
        "crypto.send.btn_pick_addr_recent": "Выбрать из последних",
        "crypto.send.btn_pick_addr_book": "Выбрать из адресной книги",
        "crypto.send.enter_addr": "<b>Введите адрес для отправления:</b>",
        "crypto.send.addr_invalid": "❌ Неверный TON-адрес.",
        "crypto.send.confirm_title": "🔸 <b>Подтвердите отправление средств:</b>",
        "crypto.send.amount_line": "<b>Сумма отправления: 🪙 {amt} {sym}</b>",
        "crypto.send.addr_line": 'Адрес отправления: <a href="{url}">{short}</a>',
        "crypto.send.memo_line": "💬 {memo}",
        "crypto.send.btn_confirm": "✅ Подтвердить",
        "crypto.send.btn_cancel": "❌ Отмена",
        "crypto.send.btn_add_memo": "Добавить комментарий / MEMO",
        "crypto.send.btn_change_addr": "Изменить адрес",
        "crypto.send.memo_title": "📤 Отправление",
        "crypto.send.memo_body": "Введите комментарий (MEMO) который хотите прикрепить к отправлению.\n\nМаксимальная длина - <b>50 символов</b>.",
        "crypto.send.memo_too_long": "❌ Слишком длинный комментарий (макс. 50 символов).",
        "crypto.send.processing_body": "🪙 <b>{amt} {sym}</b> будут отправлены на адрес <b>{short}</b> в течении пары минут.",
        "crypto.send.processing_body_html": '🪙 <b>{amt} {sym}</b> будут отправлены на адрес <a href="{url}"><b>{short}</b></a> в течении пары минут.',
        "crypto.send.btn_open_wallet": "‹ Кошелёк",
        "crypto.send.no_coins": "Нет валют, доступных для отправления.",
        "crypto.send.done_notify_html": '✅ <a href="{url}">Отправление</a> {amt} {sym}{base} успешно завершено.',
        "crypto.send.failed": "❌ Не удалось отправить. Попробуйте ещё раз позже.",
        "crypto.reorder.title": "🔁 Измените порядок кошельков в списке",
        "crypto.reorder.subtitle": "Смените отображение кошельков в их списке, чтобы быстрее открывать те кошельки, которые нужны чаще.",
        "crypto.reorder.wallet_short": "Кошелёк",
        "crypto.reorder.pick_num": "Выберите новый номер адреса",
        "crypto.reorder.pick_addr": "Выберите новый адрес на номер {n}",
        "crypto.reorder.swapped": "✅ Готово",
        "crypto.fav.set": "⭐ Главный кошелёк",
        "crypto.fav.already": "Этот кошелёк уже главный",
        "crypto.new.import_addr_btn": "📋 Импорт по адресу",
        "crypto.import_addr.title": "📋 Импорт кошелька по адресу",
        "crypto.import_addr.subtitle": "Отправьте TON-адрес одним сообщением (начинается с EQ... или UQ...).",
        "crypto.import_addr.invalid": "❌ Неверный TON-адрес. Проверь и попробуй ещё раз.",
    ...
    "en": {
        ...
        "crypto.reorder.title": "🔁 Change the order of wallets in the list",
        "crypto.reorder.subtitle": "Reorder how wallets are listed so the ones you use more often are easier to reach.",
        "crypto.reorder.wallet_short": "Wallet",
        "crypto.reorder.pick_num": "Pick a new position number",
        "crypto.reorder.pick_addr": "Pick the wallet for position {n}",
        "crypto.reorder.swapped": "✅ Done",
        "crypto.fav.set": "⭐ Main wallet",
        "crypto.fav.already": "This wallet is already the main one",
        "crypto.new.import_addr_btn": "📋 Import by address",
        "crypto.import_addr.title": "📋 Import wallet by address",
        "crypto.import_addr.subtitle": "Send your TON address as a single message (starts with EQ... or UQ...).",
        "crypto.import_addr.invalid": "❌ Invalid TON address. Check it and try again.",
    ...
    "uk": {
        ...
        "crypto.reorder.title": "🔁 Змініть порядок гаманців у списку",
        "crypto.reorder.subtitle": "Змініть відображення гаманців у списку, щоб швидше відкривати потрібні.",
        "crypto.reorder.wallet_short": "Гаманець",
        "crypto.reorder.pick_num": "Виберіть новий номер адреси",
        "crypto.reorder.pick_addr": "Виберіть нову адресу на номер {n}",
        "crypto.reorder.swapped": "✅ Готово",
        "crypto.fav.set": "⭐ Головний гаманець",
        "crypto.fav.already": "Цей гаманець уже головний",
        "crypto.new.import_addr_btn": "📋 Імпорт за адресою",
        "crypto.import_addr.title": "📋 Імпорт гаманця за адресою",
        "crypto.import_addr.subtitle": "Надішліть TON-адресу одним повідомленням (починається з EQ... або UQ...).",
        "crypto.import_addr.invalid": "❌ Неправильна TON-адреса. Перевір і спробуй ще раз.",
